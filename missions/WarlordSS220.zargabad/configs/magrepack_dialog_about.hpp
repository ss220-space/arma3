...
class MagRepack_Dialog_About
{
	...
	class Controls
	{
		...
		{
			idc = 1002;
			text = "Author: Outlawled edited by Apricot_ale";
		...
		class A_ButtonCopy: outlw_MR_RscButtonMenu
		{
			idc = 1005;
			text = "Copy";
			action = "copyToClipboard 'https://steamcommunity.com/id/Apricot_ale/';";
			x = 18.00 * GUI_GRID_W + GUI_GRID_X;
			y = 13.25 * GUI_GRID_H + GUI_GRID_Y;
			w = 4 * GUI_GRID_W;
			h = 0.8 * GUI_GRID_H;
			
			tooltip = "https://steamcommunity.com/id/Apricot_ale/";
